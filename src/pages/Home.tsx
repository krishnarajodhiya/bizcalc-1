    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.h1
              className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-gray-100 font-poppins mb-6"
            ...
            <motion.p
              className="text-xl text-gray-700 dark:text-gray-200 mb-8 max-w-3xl mx-auto font-inter"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                to="/bizcalc"
                className="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-gray-900 bg-white/80 backdrop-blur-sm hover:bg-white/90 btn-glow transition-all duration-300"
              >
                Start Calculating
              ...
              <Link
                to="/about"
                className="inline-flex items-center px-8 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-900 bg-transparent hover:bg-gray-50 btn-glow transition-all duration-300"
              >
                Learn More
              </Link>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <motion.div
                  className="text-4xl font-bold mb-2 text-gray-900 dark:text-gray-100 font-poppins"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                ...
                <div className="text-lg font-medium text-gray-700 dark:text-gray-300 font-inter">
                  {stat.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 font-poppins mb-4">
              Why Choose BizCalc?
            </h2>
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto font-inter">
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 font-poppins mb-3">
                    {feature.title}
                  </h3>
      ...
      <section className="py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto font-inter">
